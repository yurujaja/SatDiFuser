...
class NZCattle:
    def __init__(self, cfg: Dict[str, Any], split: str, augment: bool = True):
        ...
        self.dataset_path = os.path.join(geobench_path, 'segmentation_v1.0', 'm-nz-cattle')
    ...
    @staticmethod
    def get_splits(cfg: Dict[str, Any]) -> Tuple['NZCattle', 'NZCattle', 'NZCattle']:
        dataset_train = NZCattle(cfg, split="train")
        dataset_val = NZCattle(cfg, split="val")
        dataset_test = NZCattle(cfg, split="test")
